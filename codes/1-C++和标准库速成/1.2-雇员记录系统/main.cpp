...
int displayMenu();
void doHire(Database&);
void doFire(Database&);
void doPromote(Database&);
...
void doFire(Database& db)
{
	...
	catch (const std::logic_error& excpetion) {
		cerr << format("Unable to terminate employee: {}", excpetion.what()) << endl;
	}
}
